    ...
    render() {
        return (
            <div className="container">
                ...
                <StripeButton className="label-group" price= {(parseInt(this.ticket.fare)*parseInt(this.flight.quantity))+parseInt(this.flight.seat_type)} newFlight={this.flight} fromCheckIn={this.fromCheckIn}/></div>):
                (<div><p className="label-group">Total: {this.preference}</p><StripeButton className="label-group" price= {parseInt(this.preference)} newFlight={this.flight} fromCheckIn={this.fromCheckIn} bookingid={this.flight._id}/></div>)}
                </div>
            </div>
        )
    }
