...
export class updateflg extends Component {
    constructor(props) {
        super(props)
    ...
    submitHandler = event => {
        ...
        /*axios.put(`http://localhost:8064/admin/updateflg/${this.post.flight_id}`,newFlg)
        ...
        confirmAlert({
            ...
            buttons: [
              {
                label: 'Yes',
                onClick: () => axios.put(`http://localhost:8064/admin/updateflg/${this.post.flight_id}`,newFlg)
                .then(response => response)
                .catch(error => error.message)
              },
              {
          ...
          //window.alert("Flight has been successfully updated");
    ...
    render()  {
        ...
        return (
            <div className="container">
                ...
                <br/><h4 className="text-center" style={{color:'white'}}>Update Flight</h4>
                <form>
                <label className="label-group">Flight Id: {this.post.flight_id} </label><br/><br/>
                ...
                <label className="label-group">Departure Time: <input type="text" required name="time_depart" id="time_depart" oninvalid="setCustomValidity('Please enter in proper format. ')"placeholder={this.post.time_depart} value={this.state.time_depart} onChange={this.dtimeHandler}></input></label>&nbsp;&nbsp;<br/><br/>

                <label className="label-group">Arrival Time: <input type="text" required name="time_arrival" id="time_arrival" oninvalid="setCustomValidity('Please enter in proper format. ')"placeholder={this.post.time_arrival} value={this.state.time_arrival} onChange={this.atimeHandler}></input></label>&nbsp;&nbsp;<br/><br/>

                <label className="label-group">Seats Available: <input type="number" required name="seats" id="seats" oninvalid="setCustomValidity('Please enter in number format only. ')" placeholder={this.post.seats} value={this.state.seats} onChange={this.seatsHandler}/></label>&nbsp;&nbsp;<br/><br/>

                <label className="label-group">Fare: <input type="number" required name="fare" id="fare" oninvalid="setCustomValidity('Please enter in number format only. ')" value={this.state.fare} placeholder={this.post.fare} onChange={this.fareHandler}/></label>&nbsp;&nbsp;<br/><br/>
                
                <button className="btn btn-primary" type="submit" onClick={this.submitHandler}>Update</button><br/><br/>
